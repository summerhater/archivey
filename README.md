...
<p align="center"><br>기록은 모을 때가 아니라, 다시 볼 때 비로소 가치가 생깁니다.</p>
...
3. [주요 기능 및 페이지 구성](#3-주요-기능-및-페이지-구성)
    ...
    - [4) 수집물 목록과 검색 기능 (FTS)](#4-수집물-목록과-검색-기능)
    - [5) 외부 공유하기](#5-외부-공유하기)
    - [6) 설정](#6-설정)
...
* **AI 고도화**: 영상 오디오 분석 및 이미지 텍스트 요약 기능을 위한 AI 파이프라인 강화와 <br> OpenAI Whisper 연동 등 고도화 방안 검토
