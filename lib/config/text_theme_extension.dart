...
class AppTextTheme extends ThemeExtension<AppTextTheme> {
  final TextStyle headlineLargeKo;
  ...
  const AppTextTheme({
    this.headlineLargeKo = const TextStyle(
      fontFamily: 'scDream',
      fontSize: 20,
  ...
  AppTextTheme copyWith({
    ...
    return AppTextTheme(
      headlineLargeKo: headlineLargeKo ?? this.headlineLargeKo,
  ...
  AppTextTheme lerp(
    ...
    return AppTextTheme(
      headlineLargeKo: TextStyle.lerp(
        headlineLargeKo,
        other.headlineLargeKo,
        t,
      )!,
      headlineSmallEn: TextStyle.lerp(
        headlineSmallEn,
        other.headlineSmallEn,
        t,
      )!,
      headlineSmallKo: TextStyle.lerp(
        headlineSmallKo,
        other.headlineSmallKo,
        t,
      )!,
